            ...
            <div class="row">
              <div class="col-lg-12 estilo-forma">
                ...
                <div class="row center">
                  <div>
                    <a class="btn btn-info btn-lg p-5"  href="<?php echo constant('URL');?>Usuario/registro">Continuar</a>
                  </div>
                  <div>
                    <a class="btn btn-info btn-lg p-5"  href="<?php echo constant('URL');?>">Regresar</a>
                  </div>
                </div>
          </fieldset>
        </div>
