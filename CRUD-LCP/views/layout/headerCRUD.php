...
<head>
  ...
  <title>PILARES Administración</title>

  <!-- Custom fonts for this template-->
  <link href="<?php echo constant('URL')?>public/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">

  <!-- Page level plugin CSS-->
  <link href="<?php echo constant('URL')?>public/vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet">
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="http://187.216.164.109/">PILARES</a>
    ...
    -->
      <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
          ...
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="<?php echo constant('URL')?>Crud/index" data-toggle="modal" data-target="#logoutModal">Salir</a>
        </div>
      </li>
    </ul>
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="<?php echo constant('URL')?>views/crud/login.html">Login</a>
          <a class="dropdown-item" href="<?php echo constant('URL')?>views/crud/register.html">Register</a>
          <a class="dropdown-item" href="<?php echo constant('URL')?>views/crud/forgot-password.html">Forgot Password</a>
          <div class="dropdown-divider"></div>
